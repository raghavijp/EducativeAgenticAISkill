...
server_params = StdioServerParameters(
    command="python",
    args=["weather_server_regularMCP.py"]
)
...
async def create_graph(session):
    ...
    # LLM configuration
    llm = ChatGoogleGenerativeAI(model="gemini-2.0-flash", temperature=0, google_api_key="AIzaSyBM6v5eADFrmq8yP4hKqCXpqe2WlmmQ_P4")
    ...
    # Learn Langchain and lang graph to complete this section
